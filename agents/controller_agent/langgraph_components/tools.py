...
def initialize_tools(sql_agent, kg_agent, workflow_agent, llm):
    ...
    @tool
    def workflow_notify_tool(workflow_name: str) -> str:
        """Notifies the user that a specific workflow condition was triggered."""
        return workflow_agent.notify_user(workflow_name, "Condition triggered!")
