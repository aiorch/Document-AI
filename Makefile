...
release:
	...
	docker tag  ${DOCKER_REGISTRY_USER}/${APPLICATION_NAME}:${GITHUB_SHA} ${DOCKER_REGISTRY_USER}/${APPLICATION_NAME}:${RELEASE}
	docker push ${DOCKER_REGISTRY_USER}/${APPLICATION_NAME}:${RELEASE}
